...
public static partial class Run
{
    ...
    /// 最后一名玩家离开时间功能锁
    /// </summary>
    private static readonly Lock _lastPlayerLeaveTimeLock;
    /// <summary>
    /// 最后一次指令执行的时间
    /// </summary>
    ...
    /// 最后一次指令执行时间功能锁
    /// </summary>
    private static readonly Lock _lastCommandExecutionTimeLock;
    /// <summary>
    /// 是否要重启服务器
    /// </summary>
    ...
    static Run()
    {
        ...
        _lastPlayerLeaveTimeLock = new Lock();
        _lastCommandExecutionTime = null;
        _lastCommandExecutionTimeLock = new Lock();
