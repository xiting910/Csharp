...
internal sealed partial class SettingForm : Form
{
    ...
    /// <summary>
    /// 重写 <see cref="Form.OnLoad"/> 方法, 用于加载设置
    /// </summary>
    ...
    /// <summary>
    /// 重写 <see cref="Form.OnShown"/> 方法, 用于在窗口显示后调整控件位置和大小
    /// </summary>
    /// <param name="e">事件参数</param>
    ...
    /// <summary>
    /// 重写 <see cref="Form.OnFormClosing"/> 方法, 用于保存设置
    /// </summary>
    ...
    /// <summary>
    /// 重写 <see cref="Form.OnFormClosed"/> 方法, 用于释放实例
    /// </summary>
    /// <param name="e">窗口关闭事件参数</param>
